...
class HarpsDatasetSlices():
    ...
    @profile
    def __init__(self, harpnum: int, O: Quantity, P: Quantity, L: Quantity, S: Quantity, db_path: str = CMESRCV2_DB, strict: bool = False):
        """
...
def write_into_database(accepted_rows: List[accepted_row], rejected_rows: List[rejected_row], db_path: str = CMESRCV2_DB) -> None:
