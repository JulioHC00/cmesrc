...
def gather_dimming_distances():
    ...
    raw_dimmings_catalogue["max_detection_time"] = Time(raw_dimmings_catalogue["max_detection_time"].to_list())
    ...
    for dimming_id, dimming_data in tqdm(raw_dimmings_catalogue.iterrows(), total=raw_dimmings_catalogue.shape[0]):
