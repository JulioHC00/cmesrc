...
from os import walk
import numpy as np
from src.cmesrc.config import SWAN_DATA_DIR, TEMPORAL_MATCHING_FLARES_DATABASE_PICKLE, SPATIOTEMPORAL_MATCHING_HARPS_DATABASE_PICKLE, RAW_FLARE_CATALOGUE, HARPS_MATCHING_FLARES_DATABASE, HARPS_MATCHING_FLARES_DATABASE_PICKLE
...
print(final_df[final_df["FLARE_ID"] == 73212][["CME_HARPNUM_FLARE_ID", "FLARE_ID"]])
